...
WebUI.click(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/span_PC - KENNETH TEST'))

WebUI.setText(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/input_Nomor Bilyet Tercetak_xui.UI.Input-INPUTab'), 
    '98765432')

WebUI.setText(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/input_Nominal_xui.UI.Input-INPUTac'), 
    '100000000')

WebUI.sendKeys(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/input_Nominal_xui.UI.Input-INPUTac'), 
    Keys.chord(Keys.ENTER))
...
WebUI.click(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/span_O K (1)'))
