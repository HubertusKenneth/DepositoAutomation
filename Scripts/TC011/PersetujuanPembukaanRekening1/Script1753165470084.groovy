...
WebUI.setText(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTl'), 
    'HUBERTUS')

WebUI.sendKeys(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/input_Pencarian_xui.UI.Input-INPUTl'), 
    Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/span_HUBERTUS KENNETH'))

WebUI.click(findTestObject('Object Repository/PembukaanRekeningTes/Page_ARB Banking System/span_Setuju'))
